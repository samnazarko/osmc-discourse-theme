...
export default createWidget("hamburger-menu", {
  ...
  osmcLinks() {
    ...
    links.push({ href: "https://osmc.tv/", className: "osmc-link", label: "osmc.home" });
    links.push({ href: "https://osmc.tv/blog", className: "osmc-link", label: "osmc.blog" });
    links.push({ href: "https://osmc.tv/about", className: "osmc-link", label: "osmc.about" });
    links.push({ href: "https://osmc.tv/download", className: "osmc-link", label: "osmc.download" });
    ...
    const extraLinks = flatten(applyDecorators(this, "osmcLinks", attrs, state));
    return links.concat(extraLinks).map((l) => this.attach("link", l));
  },
  ...
  osmcColoredLinks() {
    ...
    links.push({ href: "https://osmc.tv/vero", className: "osmc-link-pink", label: "osmc.vero4k" });
